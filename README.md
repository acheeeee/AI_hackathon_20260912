...
**2026-09-12 盤點：既有 Vue＋舊版 API 可跑離線示範；新資料、RAG 與協作後端尚未完成整合。** 本次只驗證與整理，後續開發等待使用者明確允許。
...
- [資料目錄說明](data/README.md)：153 份原件、141 份 r1 語料及發布限制。
...
data/processed/     前處理 release；r1 保留原樣，尚未完整驗收
...
- 新 `/api/v1`、SQLite、案件版本、AI 側邊欄、diff／採用與新 RAG 都還是設計。
