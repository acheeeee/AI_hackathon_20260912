...
- section_count: 2320
- chunk_count: 2834
- index_eligible_chunk_count: 2733
- non_index_eligible_chunk_count: 101
- citation_count: 675
- citation_resolved_count: 227
...
| 主鍵唯一-section_id | PASS | n=2320 |
| 主鍵唯一-chunk_id | PASS | n=2834 |
...
| span合法性/quote可重建-chunks（全量） | PASS | mismatch_chunks=0/2834 |
| 法條邊界-附加條號存在 | PASS | 附加條號 section 數=237 |
...
| chunk契約-chunking_version齊全 | PASS | missing=0/2834 |

## 人工待辦

- 低文字頁：7（須逐頁視覺判定）
- 未歸屬行：0（進 review_queue）
- 分頁小工具造成無法逐條切分：4 部法規（見 review_queue issue_type=toc_widget_merged_articles，內容未遺失但條號粒度不足）
